 ...
 * @author Jason
 */
public class FileParserInterface extends javax.swing.JFrame {

    /**
     * Creates new form FileParserInterface
     */
    public FileParserInterface() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileParserInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FileParserInterface().setVisible(true);
            }
        });
    }
